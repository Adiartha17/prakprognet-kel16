                            ...
                            <div class="table-responsive-sm">
                                <table class="table text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            {{-- <td>
                                                <img src="{{ \Storage::url($products->product->images[0]->image_name) }}"
                                                class="img-fluid" alt=" {{ $products->produk_name }}" width="50">
                                            </td> --}}
                                            <td>{{ $products->produk_name }}</td>
                                        ...
                                        <tr>
                                            {{-- <td>
                                                <img src="{{ \Storage::url($products->products->images[0]->image_name) }}"
                                                class="img-fluid" alt=" {{ $products->products->produk_name }}" width="50">
                                            </td> --}}
                                            <td>{{ $products->products->produk_name }}</td>
