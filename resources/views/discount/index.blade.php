                    ...
                    <div class="card">
                        ...
                        <div class="container-fluid">
                            <div class="table-responsive col-lg-auto">
                                <a href="{{ Route('createnewdiscount')  }}" class="btn btn-primary my-3"> Create new Discounts</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $discount->product->produk_name }}</td>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ Route('deletediscount', $discount->id)  }}" method="post" class="d-inline">
                                                {{-- @method('delete') --}}
                                                @csrf
