            ...
            <div class="row">
              <div class="col">
                <div class="card">
                  ...
                  <div class="col-lg-8">
                    <form method="post" action="{{ Route('saveeditdiscount', $discount->id) }}" enctype="multipart/form-data">
                      {{-- @method('get') --}}
                      @csrf
                      ...
                      <button type="submit" class="btn btn-primary mb-3">Save Edit Discount</button>
                    </form>
                  </div>
                  </div>
                </div>
