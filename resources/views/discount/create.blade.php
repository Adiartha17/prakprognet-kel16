            ...
            <div class="row">
              <div class="col">
                <div class="card">
                  ...
                  <div class="col-lg-8">
                    <form method="post" action="{{ Route('savenewdiscount')  }}" enctype="multipart/form-data">
                      @csrf
                      <div class="mb-3">
                        <label for="product_name" class="form-label">Product</label>
                        <select class="form-select @error('product_name') is-invalid @enderror" id="product_name" name="product_name" aria-label="Default select example" value="{{ old('product_name') }}">
                      ...
                      <div class="mb-3">
                        ...
                        <input placeholder="" type="text" class="form-control @error('discount') is-invalid @enderror" id="discount" name="discount" value="{{ old('discount') }}">
                        @error('discount')
                          <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
