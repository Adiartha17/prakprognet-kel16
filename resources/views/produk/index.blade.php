              ...
              <tbody>
                ...
                <tr>
                  ...
                  @if ($itemimage != 0) 
                    @foreach($item as $foto)
                      ...
                      <div class="col col-lg-3 col-md-3 mb-2">
                          <form action="{{ url('/admin/produkimage/'.$foto->id_image) }}" method="post" style="display:inline;">
                              @csrf
                              {{ method_field('delete') }}
                  ...
                  <div class="form-group">
                    ...
                    <a href="/admin/products/{{ $produk->id }}" class="btn btn-sm btn-success mr-2 mb-2">
                        Detail
                    </a>
