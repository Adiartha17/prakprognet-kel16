...
class CartController extends Controller
{
    ...
    {   
        ...
        return redirect()->back()->with(compact('cart'))->withSuccess("Produk Berbasil Ditambahkan ke Keranjang");
    ...
    public function delete(Request $request)
    {
        ...
        return redirect()->route('cartlist')->withSuccess("Produk dihapus dari Keranjang");
    }
